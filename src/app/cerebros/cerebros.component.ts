...
export class CerebrosComponent implements OnInit {
  ...
  guardarDatos(id: string, flavor: string, iq: number, descripcion: string, picture: string) {
    console.log(id, flavor, iq, descripcion, picture);
    CerebrosComponent.id = id;
    CerebrosComponent.sabor = flavor;
    CerebrosComponent.iq = iq;
    CerebrosComponent.descripcion = descripcion;
